...
from get_image.src.my_yarr.envs.env import Env, MultiTaskEnv
from get_image.src.my_yarr.utils.observation_type import ObservationElement
from get_image.src.my_yarr.utils.transition import Transition
...
def _extract_obs(obs: Observation, channels_last: bool, observation_config):
    rospy.loginfo(observation_config)
    obs_dict = vars(obs)
