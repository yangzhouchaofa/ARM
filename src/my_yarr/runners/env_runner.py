...
from get_image.src.my_yarr.envs.env import Env
from yarr.replay_buffer.replay_buffer import ReplayBuffer
from get_image.src.my_yarr.runners._env_runner import _EnvRunner
        ...
        while True:
            ...
            if not self._kill_signal.value:
                ...
                for p in envs:
                    ...
                    if no_transitions[p.name] > 600000: #600:  # 5min
