...
"""rosrun get_image launch.py method=C2FARM rlbench.task=my_reach_target rlbench.demo_path=/media/ylc/YETONG/2 framework.gpu=0"""
import gc
import logging
import os
import sys
...
from get_image.src.arm.lpr.rollout_generator import PathArmRolloutGenerator
...
from yarr.replay_buffer.wrappers.pytorch_replay_buffer import \
    PyTorchReplayBuffer
from get_image.src.my_yarr.runners.env_runner import EnvRunner
from yarr.runners.pytorch_train_runner import PyTorchTrainRunner
from yarr.utils.stat_accumulator import SimpleAccumulator

from get_image.src.arm import arm, c2farm, lpr, qte
from get_image.src.arm.baselines import bc, td3, dac, sac
from get_image.src.arm.custom_rlbench_env import CustomRLBenchEnv
from pyrep.const import RenderMode

from get_image.src.my_yarr.utils.rollout_generator import RolloutGenerator
...
def main(cfg: DictConfig) -> None:
    ...
    for seed in range(existing_seeds, existing_seeds + cfg.framework.seeds):
        ...
        run_seed(cfg, env, cfg.rlbench.cameras, train_device, env_device, 0)
